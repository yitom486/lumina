...
pub fn apply_to_command(cmd: &mut Command, settings: &CookieSettings) -> Result<(), YtdlError> {
    crate::runtime::apply_to_command(cmd);
...
pub fn test_cookies(settings: &CookieSettings) -> Result<YtdlCookieTestResult, YtdlError> {
    ...
    if matches!(settings.mode, CookieMode::Browser)
        ...
        && classified.code == crate::YtdlErrorCode::LoginRequired
    {
...
mod tests {
    ...
    fn classify_login_and_cookie_errors() {
        ...
        assert_eq!(login.code, crate::YtdlErrorCode::LoginRequired);
        ...
        assert_eq!(cookie.code, crate::YtdlErrorCode::LoginRequired);
        assert!(
        ...
        assert_eq!(encrypted.code, crate::YtdlErrorCode::LoginRequired);
        ...
        assert_eq!(js.code, crate::YtdlErrorCode::ResolveFailed);
        ...
        assert_eq!(members.code, crate::YtdlErrorCode::LoginRequired);
